export default function FooterSection() {
  return (
    <div className="w-full pt-10 flex flex-col justify-start items-start">
      {/* Main Footer Content */}
      <div className="self-stretch flex flex-col sm:flex-row justify-between items-center px-4 md:px-8 pb-8 pt-0 gap-4">
        {/* Brand */}
        <div className="flex items-center gap-3">
          <div className="text-center text-[#49423D] text-xl font-semibold leading-4 font-sans tracking-wide">
            ORBIT
          </div>
          <div className="text-[rgba(73,66,61,0.60)] text-sm font-medium leading-[18px] font-sans">
